...
namespace PerseusApi.Utils
{
    public static class PerseusUtils
    {
        ...
        public static void LoadMatrixData(IDictionary<string, string[]> annotationRows, int[] mainColIndices, int[] catColIndices,
            int[] numColIndices,
            int[] textColIndices, int[] multiNumColIndices, ProcessInfo processInfo, IList<string> colNames, IMatrixData mdata,
            StreamReader reader,
            ...
            List<Tuple<Relation[], int[], bool>> filters)
        {
            ...
            LoadMatrixData(annotationRows, mainColIndices, catColIndices, numColIndices, textColIndices, multiNumColIndices,
                processInfo, colNames, mdata, reader, nrows, origin, separator, shortenExpressionNames, hasAdditionalMatrices, filters);

        }

        public static void LoadMatrixData(IDictionary<string, string[]> annotationRows, int[] mainColIndices, int[] catColIndices, int[] numColIndices,
            int[] textColIndices, int[] multiNumColIndices, ProcessInfo processInfo, IList<string> colNames, IMatrixData mdata, StreamReader reader,
            int nrows, string origin, char separator, bool shortenExpressionNames, bool hasAdditionalMatrices, List<Tuple<Relation[], int[], bool>> filters)
        {
            ...
            if (HasBadParameters(mainColIndices, catColIndices, numColIndices, textColIndices, multiNumColIndices, processInfo, colNames)) return;
            LoadMatrixData(colNames, colDescriptions, mainColIndices, catColIndices, numColIndices, textColIndices, multiNumColIndices, origin, mdata,
                processInfo.Progress, processInfo.Status, separator, reader, nrows, shortenExpressionNames, filters, hasAdditionalMatrices);
        ...
        private static void LoadMatrixData(IList<string> colNames, IList<string> colDescriptions, IList<int> mainColIndices,
            ...
            string origin, IMatrixData matrixData, Action<int> progress, Action<string> status, char separator, TextReader reader, int nrows,
            bool shortenExpressionNames, List<Tuple<Relation[], int[], bool>> filters, bool addtlMatrices)
        {
            status("Reading data");
            float[,] qualityValues;
            bool[,] isImputedValues;
            float[,] mainValues;
            LoadAllData(matrixData, colNames, mainColIndices, catColIndices, numColIndices, textColIndices, multiNumColIndices, reader, separator, nrows, filters, progress, addtlMatrices, out qualityValues, out isImputedValues, out mainValues);
        ...
        public static void LoadDataWithAnnotationColumns(IDataWithAnnotationColumns matrixData, IList<string> colNames, IList<int> catColIndices, IList<int> numColIndices, IList<int> textColIndices, IList<int> multiNumColIndices, Action<int> progress, char separator, TextReader reader, int nrows, List<Tuple<Relation[], int[], bool>> filters)
        {
            float[,] qualityValues;
            bool[,] isImputedValues;
            float[,] mainValues;
            LoadAllData(matrixData, colNames, new int[0], catColIndices, numColIndices, textColIndices, multiNumColIndices, reader, separator, nrows, filters, progress, false, out qualityValues, out isImputedValues, out mainValues);
        }
        private static void LoadAllData(IDataWithAnnotationColumns matrixData, IList<string> colNames, IList<int> mainColIndices, IList<int> catColIndices, IList<int> numColIndices, IList<int> textColIndices, IList<int> multiNumColIndices, TextReader reader, char separator, int nrows, List<Tuple<Relation[], int[], bool>> filters, Action<int> progress, bool addtlMatrices, out float[,] qualityValues, out bool[,] isImputedValues, out float[,] mainValues)
        {
        ...
        private static void AddMainColumnDescriptions(IList<string> colDescriptions, IList<int> mainColIndices, IMatrixData matrixData)
        {
        ...
        private static void AddColumnDescriptions(IList<string> colDescriptions, IList<int> catColIndices,
            IList<int> numColIndices, IList<int> textColIndices, IList<int> multiNumColIndices, IDataWithAnnotationColumns matrixData)
        {
            if (colDescriptions != null)
            {
        ...
        private static void AddAnnotationRows(IList<int> mainColIndices, IDataWithAnnotationRows matrixData, IDictionary<string, string[]> annotationRows)
        {
        ...
        private static void ReadAnnotationColumns(IList<int> catColIndices, IList<int> numColIndices, IList<int> textColIndices,
            IList<int> multiNumColIndices, string[] words, List<double[]> numericAnnotation, int count, List<double[][]> multiNumericAnnotation,
            List<string[][]> categoryAnnotation, List<string[]> stringAnnotation)
        {
        ...
        private static void ReadMainColumns(IList<int> mainColIndices, bool addtlMatrices, string[] words, float[,] mainValues,
            int count, bool[,] isImputedValues, float[,] qualityValues)
        {
        ...
        private static bool SkipCommentOrInvalid(char separator, List<Tuple<Relation[], int[], bool>> filters, bool addtlMatrices, string line, out string[] w)
        {
            w = new string[0];
        ...
        private static void InitializeAnnotationColumns(IList<int> catColIndices, IList<int> numColIndices, IList<int> textColIndices,
            IList<int> multiNumColIndices, int nrows, out List<string[][]> categoryAnnotation, out List<double[]> numericAnnotation,
        ...
        {
            return GetRowCount(reader, filters, separator, auxReader != null && GetHasAddtlMatrices(auxReader, mainColIndices, separator));
        }

        public static int GetRowCount(StreamReader reader, List<Tuple<Relation[], int[], bool>> filters, char separator, bool addtlMatrices)
        {
        ...
        public static void ReadDataWithAnnotationColumns(IDataWithAnnotationColumns data, ProcessInfo processInfo, Func<StreamReader> getReader, string name, char separator)
        {
            ...
            ReadMatrixInformation(getReader, separator, out annotationRows, out colNames, out eInds, out nInds, out cInds, out tInds, out mInds, out filters, out nrows, out hasAdditionalMatrices);
            using (var reader = getReader())
            {
                LoadDataWithAnnotationColumns(data, colNames, cInds, nInds, tInds, mInds, processInfo.Progress, separator, reader, nrows, filters);
            }
        }
        ...
        public static void ReadMatrix(IMatrixData mdata, ProcessInfo processInfo, Func<StreamReader> getReader, string name, char separator)
        {
            ...
            using (var reader = getReader())
            {
                LoadMatrixData(annotationRows, eInds, cInds, nInds, tInds, mInds, processInfo, colNames, mdata, reader, nrows, name, separator, false, hasAdditionalMatrices, filters);
            }
        }
        private static void ReadMatrixInformation(Func<StreamReader> getReader, char separator, out Dictionary<string, string[]> annotationRows,
            out string[] colNames, out int[] eInds, out int[] nInds, out int[] cInds, out int[] tInds, out int[] mInds,
        ...
        public static void ReadDataWithAnnotationColumnsFromFile(IDataWithAnnotationColumns mdata, ProcessInfo processInfo, string filename, char separator)
        {
