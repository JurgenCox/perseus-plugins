...
namespace PerseusApi.Network
{
    ...
    /// </summary>
	public interface INetworkToMatrixAnnColumns : INetworkActivity, IToMatrix
    {
        /// <summary>
        /// Process a network collection into a matrix
        /// </summary>
		...
		void ProcessData(INetworkDataAnnColumns inData, IMatrixData outData, Parameters param, ref IData[] supplData, ProcessInfo processInfo);
        ...
        Parameters GetParameters(INetworkDataAnnColumns mdata, ref string errString);
    }
}