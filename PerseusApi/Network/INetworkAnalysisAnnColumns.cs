...
namespace PerseusApi.Network
{
    ...
    /// </summary>
	public interface INetworkAnalysisAnnColumns : INetworkActivity, IAnalysis
    {
        /// <summary>
        ...
        /// <returns></returns>
		IAnalysisResult AnalyzeData(INetworkDataAnnColumns ndata, Parameters param, ProcessInfo processInfo);
