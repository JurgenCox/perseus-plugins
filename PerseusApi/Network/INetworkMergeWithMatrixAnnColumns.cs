...
namespace PerseusApi.Network
{
    ...
    /// </summary>
	public interface INetworkMergeWithMatrixAnnColumns : INetworkActivity, IMergeWithMatrix
    {
        /// <summary>
        ...
        /// <returns></returns>
		INetworkDataAnnColumns ProcessData(INetworkDataAnnColumns data, IMatrixData inMatrix, Parameters param, ref IData[] supplData, ProcessInfo processInfo);
        ...
        Parameters GetParameters(INetworkDataAnnColumns data, IMatrixData inMatrix, ref string errString);
    }
}
