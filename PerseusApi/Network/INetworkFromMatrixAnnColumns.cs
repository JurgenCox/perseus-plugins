...
namespace PerseusApi.Network
{
    ...
    /// </summary>
	public interface INetworkFromMatrixAnnColumns : INetworkActivity, IFromMatrix
    {
        /// <summary>
		...
		void ProcessData(IMatrixData inData, INetworkDataAnnColumns outData, Parameters param, ref IData[] supplData, ProcessInfo processInfo);
